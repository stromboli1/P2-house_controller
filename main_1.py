...
heatpump = Heatpump(1.5, 0, True, heating_multiplier=3, heating_fluctuation=0.05, target_temperature=21)

house = House('e', 150, 3, 19, 0, 212,[heatpump,dryer, oven], bg_coeff, 0.01, 0.01)

...
# Model: BES230011M
oven = Oven(power_usage=0.93, power_fluctuation=0.02, controllable=False, state_coeffs=oven_coeff, allowed_cycles=1, cycle_time_range=(30, 120))

# Creating dryer appliance for house
# Model: GTP7023CEGW
dryer = Dryer(power_usage=2.45, power_fluctuation=0.02, controllable=False, state_coeffs=dryer_coeff, allowed_cycles=1, cycle_time_range=(60,120))
...
house = House('d', 220, 3, 19.2, 0, 220,[heatpump,dryer, oven], bg_coeff, 0.01, 0.01)

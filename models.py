...
class Appliance():
    ...
    def tick(
            ...
            last_tick: datetime,
            date: datetime,
            state_override: Optional[bool] = None
        ...
        # Calculate the power state
        self._calculate_state(date, override)
...
class Heatpump(Appliance):
    ...
    def tick(
        ...
        # If the temperature is already at or above the max temperature, end the cycle early
